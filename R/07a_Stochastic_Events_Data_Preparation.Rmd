...
df_StevS <- df_StevS_raw <- fread(
                              file = here("output", "NetLogo_raw", "NBI_StevS_Improvements.csv"),
                              skip = 6)

# Baseline with SD 
df_StevS_Baseline <- fread(
                       file = here("output", "NetLogo_raw", "NBI_StevS_Baseline_SD.csv"),
                       skip = 6)
...
df_StevS_All_chicks <- fread(
                        file = here("output", "NetLogo_raw", "NBI_StevS_All_chicks.csv"), 
                        skip = 6)
...
df_Stev_All_chicks <- fread(
                        file = here("output", "NetLogo_raw", "NBI_Stev_All_chicks_without_Supp.csv"), 
                        skip = 6)
