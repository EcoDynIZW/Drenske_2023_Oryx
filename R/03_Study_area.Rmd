---
title: "PVA of the NBI: Study area" ## name of your project
author: "Cédric Scherer"                     ## your name(s)
...
## save map
# ggsave(here::here("plots", "NBIPVA_A_europe_countries.pdf"),
#        width = 8.95, height = 10, device = cairo_pdf)
# 
# pdf_convert(pdf = here::here("plots", "NBIPVA_A_europe_countries.pdf"), 
#             format = "png", dpi = 750)
```
...
## save map
# ggsave(here::here("plots", "NBIPVA_B_alps_GrnYl.pdf"),
#        width = 8.5, height = 10, device = cairo_pdf)
# 
# pdf_convert(pdf = here::here("plots", "NBIPVA_B_alps_GrnYl.pdf"), 
#             format = "png", dpi = 750)
```
...
## save panel
# ggsave(here::here("plots", "NBIPVA_panel_GrnYl.pdf"),
#        width = 17, height = 10, device = cairo_pdf)
# 
# pdf_convert(pdf = here::here("plots", "NBIPVA_panel_GrnYl.pdf"), 
#             format = "png", dpi = 750)
```
