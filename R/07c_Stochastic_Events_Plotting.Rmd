---
title: "PVA of the NBI: Analysis of Stochastic Event Scenarios - Plotting" ## name of your project
...
* **Data:** Results of the second NetLogo model and tables created in script 7b
...
```{r data}
df_StevS_lambda_pos <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_StevS_lambda_pos.rds"))
...
A combinded figure of the barplots for the Baseline and Improvement scenarios and the catastrophe and supplement scenarios
```{r}
...
ggplot(data = df_StevS_summ, aes(x = Stoch_Severity, 
  ...
  geom_vline(xintercept = c(0.025, 0.075, 0.125, 0.175, 0.225, 0.275), 
             ...
             size = 1) + 
  # Axis breaks
  scale_x_continuous(#name = "Catastrophe severity",  
                     breaks = c(0.05, 0.10, 0.15, 0.20, 0.25), expand = c(0, 0)) + 
  scale_y_continuous(#name = "Catastrophe frequency", 
                     breaks = c(0.05, 0.10, 0.15, 0.20), expand = c(0, 0)) + 
  # Theme
  theme(rect = element_blank(), 
        axis.text = element_text(size = 14), 
