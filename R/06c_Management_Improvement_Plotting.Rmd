---
title: "PVA of the NBI: Analysis of Management Improvement Scenarios - Plotting" ## name of your project
...
```{r data}
df_Basic_scen <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_Basic_scen.rds"))
df_lambda_pos <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_lambda_pos.rds"))
df_mean <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_mean.rds"))
df_sc_mean <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_sc_mean.rds"))
df_scen <- readRDS(file = here("output", "data-proc", "NetLogo-proc", "df_scen.rds"))
```
...
A plot of the population trajectories of the XX scnarios of special interest
...
Save the plot
```{r}
# ggsave(filename = here("plots", "04_PVA", "pop_trajectories.png"),
