...
# Life status
# svg for publication
# svg(filename = here("plots","02_survival", "survplot_life_raising_20220614.svg"), width = 3.22835, height = 2.07874)
# ggsurvplot(sfit_rt, data = NBI_RT, conf.int = T, risk.table = F, xlab = "Years", xlim = c(0,8*365.25), size = 0.8,
#            font.x = 10, font.tickslab = 9, font.y = 10,font.legend = 7,
#            ggtheme = theme_bw()+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()),
#            break.time.by = 365.25, xscale = 365.25, pval = 0.004, pval.coord = c(x = 4.5*365.25, y = 0.45), pval.size = 2.5,
...
# png(filename = here("plots","02_survival", "survplot_life_raising_20220614.png"), width = 82, height = 52.8, units = "mm", res = 2000)
# 
# ggsurvplot(sfit_rt, data = NBI_RT, conf.int = T, risk.table = F, xlab = "Years", xlim = c(0,8*365.25), size = 0.8,
#            font.x = 10, font.tickslab = 9, font.y = 10,font.legend = 7,
#            ggtheme = theme_bw()+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()),
