...
```{r col surv plot}
# Life status
ggsurvplot(sfit_2col, data = NBI_2col, conf.int = T, risk.table = F, xlab = "Years", xlim = c(0,8*365.25),
...
# life status
sfit_sc <- survfit(formula = Surv(time = NBI_timesplit_colony$TimeStart,
                                      time2 = NBI_timesplit_colony$TimeStop, 
...
```{r sc cox ph}
# life status
cox_sc <- coxph(Surv(NBI_timesplit_colony$TimeStart, NBI_timesplit_colony$TimeStop, NBI_timesplit_colony$event) ~ 
...
# Life status
ggsurvplot(sfit_rt, data = NBI_RT, conf.int = T, risk.table = F, 
           xlab = "Years", xlim = c(0,8*365.25),
           font.x = 23, font.tickslab = 22, font.y = 23,font.legend = 22,
           ggtheme = theme_bw() + 
           ...
           pval = 0.004, pval.coord = c(x = 6.75*365.25, y = 0.85), pval.size = 7,
...
# Life status
# svg for publication
# svg(filename = here("plots","02_survival", "survplot_life_raising_20220801.svg"), width = 3.22835, height = 2.07874)
# ggsurvplot(sfit_rt, data = NBI_RT, conf.int = T, risk.table = F, 
#            xlab = "Years", xlim = c(0,8*365.25), size = 0.8,
#            font.x = 10, font.tickslab = 9, font.y = 10,font.legend = 7,
#            ggtheme = theme_bw() + 
#                      theme(panel.grid.major = element_blank(), 
#                            panel.grid.minor = element_blank(), 
#                            text = element_text(family = "Open Sans")),
#            break.time.by = 365.25, xscale = 365.25, 
#            pval = 0.004, pval.coord = c(x = 4.5*365.25, y = 0.45), pval.size = 2.5,
#            legend = c(0.75,0.75), legend.title = "Raising type",
#            legend.labs = c("Foster parents", "Biological parents"),
#            palette = viridis(3, begin = 0.65, end = 0.85))
# dev.off()


# png(filename = here("plots","02_survival", "survplot_life_raising_20220801_2.png"), width = 82, height = 52.8, units = "mm", res = 2000)
#  
# ggsurvplot(sfit_rt, data = NBI_RT, conf.int = T, risk.table = F, 
#            xlab = "Years", xlim = c(0,8*365.25), size = 0.8,
#            font.x = 10, font.tickslab = 9, font.y = 10,font.legend = 7,
...
#            break.time.by = 365.25, xscale = 365.25, 
#            pval = 0.004, pval.coord = c(x = 4.5*365.25, y = 0.45), pval.size = 2.5,
#            legend = c(0.76,0.75), legend.title = "Raising type",
#            legend.labs = c("Foster parents", "Biological parents"),
#            palette = viridis(3, begin = 0.65, end = 0.85))
#  
# dev.off()
...
# life status
sfit_srt <- survfit(formula = Surv(time = NBI_timesplit_srt$TimeStart,
                                      time2 = NBI_timesplit_srt$TimeStop, 
...
# # project status
# sfit_srt2 <- survfit(formula = Surv(time = NBI_timesplit_srt2$TimeStart,
#                                       time2 = NBI_timesplit_srt2$TimeStop, 
...
```{r srt cox ph}
# life status
cox_srt <- coxph(Surv(NBI_timesplit_srt$TimeStart, NBI_timesplit_srt$TimeStop, NBI_timesplit_srt$event) ~ 
...
# # Project status
# cox_srt2 <- coxph(Surv(NBI_timesplit_srt2$TimeStart, NBI_timesplit_srt2$TimeStop, NBI_timesplit_srt2$event) ~ 
