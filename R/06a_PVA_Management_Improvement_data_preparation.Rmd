...
df_Basic <- 
  df_Basic_raw <- fread(file = here("output", "NetLogo_raw", "NBI_Baseline_and_Improvements.csv"),
                        skip = 6)

# Baseline with SD
df_Baseline_SD <- 
  df_Baseline_SD_raw <- fread(file = here("output", "NetLogo_raw", "NBI_Baseline_SD.csv"),
                              skip = 6)
...
df_All_Chicks <- 
  df_All_Chicks_raw <- fread(file = here("output", "NetLogo_raw", "NBI_All_chicks_Statquo.csv"), 
                             skip = 6)
...
df_Baseline_100 <- 
  df_Baseline_SD_raw <- fread(file = here("output", "NetLogo_raw", "NBI_Baseline_SD_100years.csv"),
                              skip = 6)
```
...
# Save data
```{r}
# saveRDS(object = df_Basic, file = here("output", "data-proc", "NetLogo-proc", "df_Basic.rds"))
# saveRDS(object = df_Baseline_100, file = here("output", "data-proc", "NetLogo-proc", "df_Baseline_100.rds"))
```

# Questions/To Do
EIgentlich sollten die SPalten für die Kolonien usw entfernt werden oder in Netlogo muss boch Rosegg hinzugefügt werden
