...
In this script we calculated the fecundity for the population.
The fecundity is calculated is the number of fledged female chicks per year divided by the number of potential mothers per year.
...
For the "Baseline" Fecundity we used only female fledged chicks which are born in the population from mothers who lived/lives in the population.
