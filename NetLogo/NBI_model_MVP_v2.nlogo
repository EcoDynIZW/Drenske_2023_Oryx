...
to death
  ask turtles with [(age = 0)  and (raising = "FP")]                                ; death probabilities per step for stage 1, the juveniles
     [
       ;print Mortality_FP_Juveniles
        if random-float 1 < Mortality_FP_Juveniles                 ; test if the random number is smaller than the mortality probability for Juveniles
         [                                                     ; if it is, then
   ...
   ask turtles with [(age = 0)  and (raising = "P")]                                ; death probabilities per step for stage 1, the juveniles
     [
       if random-float 1 < Mortality_P_Juveniles                 ; test if the random number is smaller than the mortality probability for Juveniles
         [                                                     ; if it is, then
           set deaths deaths + 1                               ; increase Deaths (Monitor) by 1 per death individual
          ; print "Juvenile dies"                              ; print "Juvenile dies"
           die                                                 ; die
   ...
   ask turtles with [(age = 1)  and (raising = "FP")]                                  ; death probabilities per step for stage 2, the 1-Year-Olds
     [
       if random-float 1 < Mortality_FP_Subadults_Age1
         [
           set deaths deaths + 1
   ...
   ask turtles with [(age = 1)  and (raising = "P")]                                  ; death probabilities per step for stage 2, the 1-Year-Olds
     [
       if random-float 1 < Mortality_P_Subadults_Age1
         [
           set deaths deaths + 1
          ; print "Subadult 1 dies"
           die
   ...
   ask turtles with [(age = 2)  and (raising = "FP")]                                  ; death probabilities per step for stage 3, the 2-Year-Olds
     [
       if random-float 1 < Mortality_FP_Subadults_Age2
         [
           set deaths deaths + 1
  ...
  ask turtles with [(age = 2)  and (raising = "P")]                                  ; death probabilities per step for stage 3, the 2-Year-Olds
     [
       if random-float 1 < Mortality_P_Subadults_Age2
         [
           set deaths deaths + 1
          ; print "Subadult 2 dies"
           die
   ...
   ask turtles with [(age >= 3)  and (raising = "FP")]                                 ; death probabilities per step for stage 4, the adults
     [
       if random-float 1 < Mortality_FP_Adults
         [
           set deaths deaths + 1
          ; print "Adult dies"
           die
  ...
  ask turtles with [(age >= 3)  and (raising = "P")]                                 ; death probabilities per step for stage 4, the adults
     [
       if random-float 1 < Mortality_P_Adults
         [
           set deaths deaths + 1
          ; print "Adult dies"
           die
...
count turtles &lt; 1</exitCondition>
  ...
  <experiment name="Cata_all_chicks_without_Supp" repetitions="100" runMetricsEveryStep="true">
    <setup>prep
setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
...
count turtles &lt; 1</exitCondition>
  ...
  <experiment name="MVP_good_8y" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <exitCondition>count turtles &gt; 5000  or 
count turtles &lt; 1</exitCondition>
  ...
  <experiment name="MVP_conservative_8y" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <exitCondition>count turtles &gt; 5000  or 
