             ...
             [                                                  ; if it is, then
               hatch 1                                          ; hatch 1 chick (turtle)
                 [                                              ; this chick has the following properties
                   ...
                   set age -1                                   ; set age to -1, because these chicks age in the same tick again, but that should not be, only in the next step
...
;; Breeding with Probability for the number of hatches
;to breeding
;   let chicks random-float 1
;   ask turtles with [age >= 3]
;     [
;       ifelse chicks < Probability_4_Hatch
;         [hatch 4]
;         [ifelse chicks < Probability_1_Hatch
;           [hatch 1]
;           [ifelse chicks < Probability_3_Hatch
;             [hatch 3]
;             [ifelse chicks < Probability_2_Hatch
;               [hatch 2]
;               [hatch 0]
;            ]
;          ]
...
to catastrophe
   if Catastrophes?                                            ; test if the switch "Catastrophes?" is "On"
     [                                                         ; if it is, then ...
...
;         [                                                     ; if it is, then ...
;           print "Catastrophe"
;           let Seve random-float 1
;           ask turtles                                         ; ask Turtles
;             [
;               if Seve < Severity                    ; is the random number between 0 and 1 smaller than the Severity?
;                 [                                             ; if it is, then ...
;                   set deaths deaths + 1                       ; increase Deaths (Monitor) by 1
;                   die                                         ; die
;                 ]
...
to prep
  ...
  if scenario = "Mid_Lambda1"
    [
     set Mortality_Juveniles 0.32
     set Mortality_Subadults_Age1 0.19
     set Mortality_Subadults_Age2 0.15
     set Mortality_Adults 0.24
     set Fecundity 0.51
    ]
  if scenario = "Mid_Lambda2"
    [
     set Mortality_Juveniles 0.22
     set Mortality_Subadults_Age1 0.19
     set Mortality_Subadults_Age2 0.15
  ...
  if scenario = "Mid_Lambda3"
    [
     set Mortality_Juveniles 0.22
     set Mortality_Subadults_Age1 0.07
     set Mortality_Subadults_Age2 0.25
     set Mortality_Adults 0.31
     set Fecundity 0.58
    ]
  if scenario = "100Fecun_Mid_Lambda4"
    [
     set Mortality_Juveniles 0.38
     set Mortality_Subadults_Age1 0.26
     set Mortality_Subadults_Age2 0.32
...
1830
734
Age newborns = -1\noder lieber mortalities und fecundity um ein Jahr schieben?\nAlle Adults sind 3, ist das ein Problem?\n\nHier höhere Todeszahlen, da man nur einmal sterben kann. (Beim Matrixmodell werden aus derselben Zahl bei den Subadults die Subadults und Adults des nächsten Jahres berechnet\n\nWas ist mit Tieren der \"Kolonie\" Zu? Habe sie jetzt unter den drei Kolonien aufgeteilt
11
0.0
1
...
393
359
Je nachdem was genutzt werden soll, muss dies im Code Tab eingestellt werden. \n\nAuf die Reihenfolge der Hatch Probability achten (geringste Wahrscheinlichkeit zuerst)
11
0.0
1
...
555
683
Bis jetzt werden keine Auswirkungen auf die Fecundity festgehalten, nur auf Survival
11
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="Baseline_and_Improvements" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <exitCondition>count turtles &gt; 5000  or 
count turtles &lt; 1</exitCondition>
    <metric>(word Mortality_Juveniles Mortality_Subadults_Age1 Mortality_Subadults_Age2 Mortality_Adults Fecundity Supplements? Number_Supplements Supplement_Time Catastrophes? Frequency Severity)</metric>
  ...
  <experiment name="Statquo_All_chicks" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <exitCondition>count turtles &gt; 5000  or 
count turtles &lt; 1</exitCondition>
  ...
  <experiment name="CataS_Baseline_and_Improvements" repetitions="100" runMetricsEveryStep="true">
    <setup>prep
setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
...
count turtles &lt; 1</exitCondition>
    ...
    <enumeratedValueSet variable="scenario">
      ...
      <value value="&quot;Mid_Lambda1&quot;"/>
      <value value="&quot;Mid_Lambda2&quot;"/>
      <value value="&quot;Mid_Lambda3&quot;"/>
      <value value="&quot;100Fecun_Mid_Lambda4&quot;"/>
      <value value="&quot;Mid_Lambda5&quot;"/>
      <value value="&quot;Max_Lambda5&quot;"/>
      <value value="&quot;Max_Lambda4&quot;"/>
      <value value="&quot;Max_Lambda3&quot;"/>
      <value value="&quot;Max_Lambda2&quot;"/>
      <value value="&quot;Max_Lambda1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Number_Juveniles">
      <value value="16"/>
    </enumeratedValueSet>
  ...
  <experiment name="CataS_all_chicks" repetitions="100" runMetricsEveryStep="true">
    <setup>prep
setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
